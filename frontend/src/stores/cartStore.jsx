...
export const cartStore = create((set) => ({
  ...
  numberOfProducts: loadCartFromLocalStorage().map((item) => item.quantity || 1) // Default to 1 of quantity is undefined.
  ...
  set((state) => {
    ...
    if (itemToAdd) {
      const updatedCart = [...state.cart];
      const existingItemIndex = updatedCart.findIndex((cartItem) => cartItem._id === itemToAdd._id);
