...
export const UnHandledBooking = () => {
    ...
    const aboutThisPageText = (
        <>
            Welcome to the Unhandled Bookings Overview Page! <br /><br />Here, you can review and manage all the surfing bookings that you have not yet accepted.
            <br /><br />
            ...
            <br /><br />
            Accept Bookings: Need to accept a booking?<br /> The 'accept' button allows you to quickly and easily accept individual bookings.
            <br /><br />
