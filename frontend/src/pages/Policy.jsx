      ...
      <div className="main-container">
        <div className="main-wrapper">
          ...
          <div className="terms-wrapper">
            <ul>
              <li>
                <span>Acceptance of Terms:</span> By using the Green Buddy app, you agree to
                abide by these terms and conditions.
              </li>
              <li>
                <span>Intellectual Property:</span> You must respect Green Buddy&apos;s
                intellectual property rights, and you are not allowed to reproduce
                the service elsewhere.
              </li>
              <li>
                <span>Content Posting:</span> When creating an ad or sharing content on the
              ...
              <li>
                <span>Limited Responsibility:</span> Green Buddy has limited responsibility
                for the availability, performance, and correctness of information
                provided through the Service.
              </li>
              <li>
                <span>Privacy Policy:</span> You should be aware that Green Buddy handles
                personal information according to the current Privacy Policy.
              </li>
              <li>
                <span>Changes to Terms:</span> Green Buddy reserves the right to update these
                terms, and users will be notified of any changes.
              </li>
              <li>
                <span>Termination:</span> Green Buddy reserves the right to terminate user
                accounts for violations of these terms.
              </li>
              <li>
                <span>Dispute Resolution:</span> Any disputes will be resolved through
