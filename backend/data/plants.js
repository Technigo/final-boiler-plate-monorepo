...
// CHANGED, NOT USING THIS ANYMORE
//  watering -
...
[
  {
    ...
    common_names: ["Fiddle Leaf Fig Bush", "Little Fiddle"],
    category_type: ["ficus", "green", "tree", "popular"],
    origin: "Tropical western and central Africa",
    description:
      "Sculptural and dramatic, this plant will flourish in the right conditions with a little extra care. The Ficus Lyrata is also called the violin plant. This name has been given by the enormously firm long leaves that the plant develops. The Ficus Lyrata owes its roots to the tropical rainforests throughout West Africa. Will you adopt this stylish plant?",
    fun_fact:
  ...
  },
  {
    ...
    common_names: [
      "Swiss Cheese or Hurricane Plant",
      "Fruit Salad Plant",
      "Monstera",
    ],
    category_type: ["philodendron", "climbing", "green", "popular"],
    origin: "Mexico, Central America",
    description:
      "Lively and wild with large, tropical leaves. Also known as the Swiss Cheese Plant. When placed in the right environment, Monsteras are easy to care for and fast-growing—so give it some space to spread out, make a statement, and thrive! As the Monstera grows, its leaves will develop long ribbons and holes, resembling swiss cheese, giving it a distinct, graphic appearance. Will you take her home?",
    fun_fact:
  ...
  },
  {
    ...
    botanical_name: "Zamioculcas zamiifolia 'dowon'",
    common_names: ["Raven ZZ Plant"],
    category_type: ["zamioculcas", "black", "popular"],
    origin: "Tropical East and Southern Africa, South Africa",
    description:
      "Jet-black leaflets adorn gracefully arching stalks of the low maintenance Raven ZZ Plant. New leaves emerge chartreuse and darken with age, providing deep contrast for added drama. ZZ plants are famously tough, able to thrive in any light level and requiring very infrequent watering. Keep the glossy leaves gleaming with a pair of microfiber dusting gloves.",
    fun_fact: "",
    height: "±45cm",
    poisonous: "This plant is considered toxic to pets and humans if ingested.",
    careDetails: {
      care_description:
  ...
  },
  {
    ...
    category_type: ["zamioculcas", "green"],
    origin: "Tropical East and Southern Africa, South Africa",
    description:
      "This indoor plant is resilient, making it fitting for the forgetful plant owner. The easy-care ZZ Plant is able to survive for weeks without water and will grow well in any light except direct sunlight. With elegant, wand-like stems that taper to a point, this foliage plant has shiny, oval-shaped leaves which give it a distinctive feathered appearance. Also great as an air cleaner, the ZZ Plant removes harmful chemicals such as formaldehyde from the air of your home or office. Native to East Africa, this plant requires very little water and does best when it is basically ignored. If you're looking for a hands-off plant that makes a statement, the ZZ Plant is it!",
    fun_fact:
  ...
  },
  {
    ...
    category_type: ["pilea", "pet-friendly", "green"],
  ...
  },
  {
    ...
    botanical_name: "Spathiphyllum spp. 'sweet pablo'",
    common_names: ["Peace Lily"],
    category_type: ["spathiphyllum", "green", "flowers", "popular"],
  ...
  {
    plantID: 8,
    plant_title: "Scandens Micans",
    botanical_name: "Philodendron hederaceum 'Micans'",
    common_names: ["Philodendron Micans Velvet"],
    category_type: ["philodendron", "climbing", "hanging", "red", "green"],
    origin: "West Indies, Central America, western and northern South America",
    description:
      "Velvet Leaf Philodendron is a little gem that has velvety, heart-shapes leaves that are quilted in texture. Her foliage can appear deep green or rich purple that can grow up to a foot in diameter, given the opportunity and care. Will be a great addition to any plant collection.",
    fun_fact: "There are nearly 500 species of Philodendron!",
    height: "±10cm",
    careDetails: {
      care_description:
  ...
  {
    plantID: 9,
    plant_title: "Medallion",
    botanical_name: "Calathea veitchiana 'Medallion'",
    common_names: ["Calathea Medallion", "Prayer Plant"],
    category_type: ["pet-friendly", "calathea", "green", "striped", "red"],
    ...
    fun_fact: "Most Calathea varieties are pet-friendly!",
    height: "±30cm",
    poisonous:
  ...
  },
  {
    ...
    common_names: ["Snake Plant", "Sansevieria", "Mother in Law's Tongue"],
    category_type: ["asparagaceae", "green"],
    origin: "West Africa",
    description:
  ...
  {
    plantID: 11,
    plant_title: "Burgundy Rubber Tree",
    botanical_name: "Ficus elastica 'Burgundy'",
    common_names: ["Burgundy Rubber Tree"],
    category_type: ["ficus", "black"],
  ...
  },
  {
    ...
    common_names: ["Tineke Rubber Tree"],
    category_type: ["ficus", "variegated", "popular", "greeen", "white"],
    origin: "Eastern Himalayas, Southeast Asia",
    description:
      "The Ficus Tineke (Ficus elastica), the vibrant younger sibling of our popular Burgundy Rubber Tree. Boasting variegated leaves in hues of creamy pink, yellow, and green, this rubber tree is a captivating presence in any interior setting, whether it graces your space solo or thrives amidst your collection.",
    fun_fact:
      "Your Ficus may enter a period of dormancy where growth will slow in the cold fall and winter months, perking back up in the spring and summer.",
    height: "±30cm",
    careDetails: {
  ...
  {
    plantID: 13,
    plant_title: "Cat Palm",
    botanical_name: "Chamaedorea cataractarum",
    common_names: ["Cat Palm", "Cascade Palm", "Cataract Palm"],
    category_type: ["arecaceae", "pet-friendly", "palm"],
    origin: "Mexico, Guatemala",
    description:
      "The Cat Palm is sure to become a favorite thanks to its lush tropical appearance and dense green foliage. The Cat Palm's fluffy leaves and short trunk give the feeling of a jungle oasis in your very own home. As one of our fullest plants, this palm is ready to make a statement. The Cat Palm is easy to care for and prefers indirect bright light.",
    fun_fact: `The cat palm's name, Chamaedorea cataractarum, comes from the Latin word "cataractarum," meaning "waterfall." It's named for its native habitat near waterfalls in Mexico and Guatemala.`,
    height: "±90cm",
    careDetails: {
      care_description:
  ...
  },
  {
    ...
    common_names: ["Spider Ivy", "Airplane Plant", "Ribbon Plant"],
    category_type: ["asparagaceae", "pet-friendly", "green", "hanging"],
  ...
  },
  {
    ...
    common_names: ["Acorn Peperomia", "Four-leaved Peperomia"],
    category_type: [
      "piperaceae",
      "semi-succululent",
      "green",
  ...
  },
  {
    ...
    category_type: ["arecaceae", "palm", "tree", "green", "pet-friendly"],
    ...
    fun_fact:
      "The parlor palm, despite its name, isn't a true palm. It belongs to the Chamaedorea genus and is often called the 'bamboo palm' or 'neanthe bella palm.'",
    height: "±45",
    careDetails: {
      care_description:
        "Palms are robust, low maintenance, and a classic addition to any plant collection. Though Palms are unmistakably tropical, their elegant fronds will complement any decor. Palms tend to grow slowly, so you don't need to worry about them outgrowing their spot too quickly.",
  ...
  {
    plantID: 19,
    plant_title: "Chinese Evergreen Crete Flame",
    botanical_name: "Aglaonema",
    common_names: [
      "Crete Aglaonema Flame",
      "Red Aglaonema",
      "Chinese Evergreen 'Crete'",
      "Aglaonema 'Siam Aurora'",
      "Siam Aglaonema",
      "Firecracker Aglaonema",
    ],
    category_type: ["araceae", "red", "pink"],
    ...
    fun_fact: "Aglaonemas are exceptional air purifiers.",
    height: "±25",
    careDetails: {
      care_description:
  ...
  },
  {
    ...
    botanical_name: "Nephrolepis exaltata 'Boston'",
    common_names: ["Sword Fern", "Green Lady"],
    category_type: ["Nephrolepidaceae", "green", "pet-friendly"],
    origin: "Tropical regions of the Americas",
    description:
      "This stylish plant is the Boston Fern, also known as the Nephrolepis Exaltata Green Lady. She has feather-like leaves, coloured in a fresh green colour. She is a very full plant that looks quite bushy. A good addition for every stylish interior lover!",
    fun_fact:
      "Your Boston Fern can handle occasional forgetfulness and survive short periods without water. However, it may not be very happy if you let it go too long without water.",
    height: "±50",
    careDetails: {
      care_description:
      ...
      care_level: "Average",
      watering:
        "She will grow the best in a slightly moist potting soil, you can achieve this by giving small amounts of water on a regular base.",
      light:
        "The Boston Fern will be happiest at a spot near a north or east facing window. A little morning sun will do her good.",
      benefits: "Air cleaner",
    },
    images: {
      preview_url: "",
  ...
  },
  {
    ...
    category_type: ["tree", "pachira", "green", "pet-friendly"],
  ...
  {
    plantID: 22,
    plant_title: "Philodendron Lemon Lime",
    ...
    category_type: ["lime", "green", "climbing"],
    origin: "Tropical regions of the Americas",
    description:
      "The Philodendron Lemon Lime is a visually striking plant known for its vibrant, heart-shaped leaves with lemon and lime-colored accents. With a glossy texture and vining habit, it adds a tropical touch to indoor spaces. Thriving in bright, indirect light and consistently moist soil, it's versatile for hanging baskets or shelves. Its relatively fast growth makes it a lively and low-maintenance choice for plant enthusiasts.",
    fun_fact: "There are nearly 500 species of Philodendron!",
    height: "±20",
    careDetails: {
      care_description:
  ...
  },
  {
    ...
    common_names: ["White Wave", "Philodendron Birkin"],
    category_type: ["stripes", "philodendron", "climbing"],
    origin:
      "Relatively new hybrid, many philodendrons hail from the lush rainforests of Brazil and Paraguay",
    description:
  ...
  },
  {
    ...
    careDetails: {
      ...
      light:
        "Natural, bright light is important for your Philodendron mayoi, but ideally, it should be indirect. A couple of hours of morning sun near a north or east-facing window shouldn't be harmful.",
      benefits: "Air cleaner",
    },
    images: {
      preview_url: "",
  ...
  {
    plantID: 25,
    plant_title: "Philodendron Brasil",
    ...
    category_type: ["philodendron", "climbing", "green", "variegated"],
    origin: "Rainforests of South America",
    description:
      "The Philodendron Brasil is loved for her heart shaped leaves that have a chunky, bright lime coloured stripe in the centre. This gives the plant a cool pop of colour that really stands out next to her dark green colour remaining parts of the leaf. Her vines can get really long, so you can cover your urban jungle in her cute leaves in no time!",
    fun_fact: "There are nearly 500 species of Philodendron!",
    height: "±35",
    careDetails: {
      care_description:
  ...
  },
  {
    ...
    common_names: ["Blushing Philodendron", "Philodendron pink princess"],
    category_type: ["philodendron", "variegated", "green", "pink", "climbing"],
    origin: "Columbia",
    description:
    ...
    fun_fact:
      "The cost is especially high since these plants are not easily grown from seed due to their variegation being a result of mutation.",
    height: "±5",
    careDetails: {
      care_description:
        "Philodendrons are fast-growing, easy plants. They range in growth pattern from graceful and vining to bold and bushy. Philodendrons are generally forgiving and will tolerate all kinds of neglect including low light, poor soil, and inconsistent watering.",
  ...
  {
    plantID: 27,
    plant_title: "Rhaphidophora Variegata",
    botanical_name: "Rhaphidophora tetrasperma 'variegata'",
    common_names: [
      "Mini Monstera",
      "Monstera Minima",
    ...
    fun_fact:
      "Known for looking like a miniature version of monstera deliciosa, this mini monstera has dramatically variegated leaves that are deeply serrated. It packs a bold punch into a tiny plant!",
    height: "±25",
    careDetails: {
      care_description:
  ...
  {
    plantID: 28,
    plant_title: "Rhaphidophora Mini Monstera",
    ...
    category_type: ["rhaphidophora", "green", "climbing"],
    origin: "Thailand and Malaysia",
    description:
      "Named for their resemblance to the magnificent Monstera deliciosa, the mini monstera is actually not a monstera but a part of an independent genus, Rhaphidophora.",
    fun_fact:
      "This plant loves to climb! You can train it up a trellis or a pole.",
    height: "±30",
    careDetails: {
  ...
  {
    plantID: 30,
    plant_title: "Red Prayer Plant",
    botanical_name: "Maranta leuconeura",
    common_names: ["Prayer Plant", "Herringbone Plant", "Maranta Prayer Plant"],
    category_type: [
      "marantaceae",
      "green",
      "colorful",
    ...
    description:
      "The Red Prayer Plant is an easy plant — place it in a sunny spot, keep its soil damp, and mist its leaves once a week and it will flourish. Gaining its name from the way the leaves fold in the evening resembling hands folded in prayer, the Red Prayer Plant is a fan favorite among plant enthusiasts. Native to the rainforests of Brazil, the Prayer Plant prefers bright, indirect sunlight and high humidity.",
    fun_fact:
  ...
  {
    plantID: 31,
    plant_title: "Dracaena Golden Coast",
    botanical_name: "Dracaena fragrans 'Golden Coast'",
    common_names: ["Corn Plant", "Dragon Tree"],
    category_type: ["asparagaceae", "green", "tree"],
    origin: "Tropics of Africa",
    description:
      "An eye-catching evergreen Dragon Tree with long, bright green foliage trimmed with a bright gold margin. The striking, variegated foliage of Dracaena fragrans 'Golden Coast' makes this an amazing specimen plant for your home. This is a versatile and easy to grow plant that will give years of pleasure.",
    fun_fact:
  ...
  {
    plantID: 32,
    plant_title: "Alocasia Zebrina",
    botanical_name: "Alocasia zebrina",
    common_names: [
      "Elephant Ears",
      "Zebra Plant",
      "Zebrina alocasia",
      "tiger taro (gabing tigre)",
    ],
    category_type: ["araceae", "green", "striped"],
    origin: "Rainforest of Southeast Asia",
    description:
    ...
    careDetails: {
      ...
      light:
        "Your Alocasia Zebrina will thrive in bright indirect light. Never allow your plant to stand in the direct sunlight—the leaves will burn. If you don't have an ideal location for your Alocasia, use a Grow Light.",
      benefits: "Air cleaner",
    },
    images: {
      preview_url: "",
  ...
  {
    plantID: 33,
    plant_title: "Calathea White Fusion",
    botanical_name: "Calathea lietzei 'White Fusion'",
    common_names: [
      "Prayer Plant",
      "Shadow Plant",
      "Peacock Plant",
    ...
    origin: "Central Mexico to tropical South America",
    description:
      "The Calathea originates from the tropical rain forests of Southern America. In these rainforests they grow in the shadows of trees and other big plants, which is why they are also called “Shadow plant”. This beautiful Calathea White Fusion is rare because of her variegated leaves. Asides from that she also has air filtering qualities, so that's a win-win!",
    fun_fact:
    ...
    careDetails: {
      ...
      care_level: "Hard",
      watering:
        "The calathea 'White Fusion' prefers to be consistently moist, but soggy and waterlogged conditions are a recipe for disaster. Once the top inch of soil is dry, your plant needs more water.",
      light:
  ...
  {
    plantID: 34,
    plant_title: "Crystallinum",
    botanical_name: "Anthurium Crystallinum",
    common_names: ["Flamingo Flower", "Crystal anthurium", "Crystal laceleaf"],
    category_type: ["araceae", "green", "striped", "rare", "trendy"],
    origin: "Rainforest of Central and South America",
    description:
      "This gorgeous plant is a really good addition to your velvet foliage collection! The Anthurium Crystallinum has oval-shaped leaves with silvery veins. New leaves start out with a bit of a yellow or red tone and slowly fade down into a dark green colour. This makes her even more interesting to look at!",
    fun_fact:
  ...
  {
    plantID: 35,
    plant_title: "Hoya Carnosa Tricolor",
    botanical_name: "Hoya Carnosa 'Tricolor'",
    common_names: ["Porcelain flower", "Wax Plant", "Wax Flower"],
    category_type: [
      "hoya",
      "green",
      "pink",
    ...
    description:
      "The Hoya Carnosa Tricolor is a beautiful plant with thick leaves. Green with white variegated edges and pink variegation throughout. Which makes the plant look super playful. This colourful plant can even grow some wax flowers for you! These are white with a pinkish center, which matches the plant perfectly. These flowers have an amazing scent. Which makes her not only a delight for your eyes, but also for your nose.",
    fun_fact:
    ...
    careDetails: {
      ...
      light:
        "Bright, indirect light - direct sun will encourage more pink variegation",
      benefits: "Air cleaner",
    },
    images: {
      preview_url: "",
  ...
  {
    plantID: 36,
    plant_title: "Skeleton Key",
    botanical_name: "Epipremnum pinnatum",
    common_names: ["Dragon-tail Plant", "Centipede Tongavine", "Silver vine"],
    category_type: ["araceae", "green", "climbing"],
    origin: "Tropical & Subtropical Asia to Pacific",
    description:
      "The Epipremnum Skeleton Key has very oddly shaped leaves and with one glance you might recognize the thin key shape where she earned her slightly spooky nickname from. Very cool if you ask us! You can either let her long vines trail down or give her some support to climb onto. Either option will give you the enchanting looks that this plant has to offer.",
    fun_fact:
      "This plant is sometimes confused with a similar plant in the same family, Epipremnum aureum, also known as pothos, money plant, or devil's ivy. Both plants have shiny green leaves and grow vigorously.",
    height: "±60",
    careDetails: {
      care_description:
      ...
      light:
        "The epipremnum pinnatum can grow in partial shade or partial sun. The best light conditions are bright but indirect sun, which you can achieve by placing it to the side of a window with good sun exposure.",
      benefits: "Air cleaner",
    },
    images: {
      preview_url: "",
  ...
  {
    plantID: 37,
    plant_title: "Fishbone Cactus",
    botanical_name: "Disocactus anguliger",
    common_names: [
      "Fishbone Cactus",
      "Zig Zag Cactus",
      "Ricrac Cactus",
    ...
    category_type: ["green", "cactus", "hanging", "succulent"],
    origin: "Mexico",
    description:
      "This unique looking cactus is called Epiphyllum anguliger, but she is better known as 'Fishbone Cactus'. This is due to her resemblance to a fishbone, cool right? Besides these quirky looking leaves she can also surprise you with gorgeous flowers!",
    fun_fact:
      "The Fishbone Cactus produces beautiful and fragrant flowers, typically during the nighttime. The nocturnal blooming is an adaptation to attract pollinators like moths and bats, which are more active during the evening hours. This interesting behavior adds a touch of mystery and charm to the Fishbone Cactus.",
    height: "±60",
    careDetails: {
      care_description:
      ...
      care_level: "Easy",
      watering:
        "In contrast to desert cacti, the fishbone cactus appreciates regular watering. As a general rule, you should water your cactus once the top 2-3 inches of the soil have dried out. Fishbone cacti are also sensitive to chemicals in municipal water so if your water is hard you should allow it to sit out for 24 hours before watering your cactus, or use distilled water.",
      light:
  ...
  {
    plantID: 38,
    plant_title: "Prickly Pear Cactus",
    botanical_name: "Opuntia spp.",
    common_names: ["Prickly Pear", "Indian fig", "Barbary fig", "Nopal cactus"],
    category_type: ["green", "cactus", "cactaceae"],
    origin: "North and South America",
    description:
      "Meet the charming Prickly Pear Cactus, also known as Opuntia, a delightful addition to your green oasis!  Its simple yet captivating presence can turn any corner of your urban jungle into a vibrant and enchanting desert escape. Let this resilient succulent remind you that even in the prickliest situations, beauty and tenacity can coexist.",
    fun_fact:
  ...
  {
    plantID: 39,
    plant_title: "Golden Barrel Cactus",
    botanical_name: "Echinocactus grusonii",
    common_names: ["Golden Ball", "Mother-in-law's Cushion"],
    category_type: ["green", "cactus", "cactaceae"],
    origin: "North America",
    description:
      "Admire the Golden Barrel Cactus's easygoing nature as it sits in its pot, a testament to the beauty found in simplicity. No need for excessive fuss—just provide it with ample sunlight, and Sunny will thrive, gracing your urban jungle with a desert-inspired glow. So, are you ready to let this cactus join your plant family? Let this little sunbeam infuse your space with golden vibes and make your urban jungle shine a bit brighter!",
    fun_fact:
      "They can produce flowers but usually won't start doing that until they are at least 6 inches wide, which can take about 15 years.",
    height: "±60",
    careDetails: {
      care_description:
        "Golden barrel cactus can be grown indoors. They aren't difficult to grow as long as these plants have the brightest, sunniest location. Usually, southern-facing windows offer the strongest sun. These are true, extreme desert plants that cannot handle standing water.",
      care_level: "Easy",
      watering:
        "Golden barrel cactus are prone to root rot. From fall to spring, water infrequently (every month or two) and ensure that the soil drains completely. Do not leave any water in the tray or allow it to sit in water. In winter, simulate drought conditions, giving no water. In early spring, gradually provide some water, increasing water to once per week in spring and summer, ensuring the water drains completely.",
      light:
  ...
  {
    plantID: 40,
    plant_title: "Garnet Lotus",
    botanical_name: "Crassula arborescens",
    common_names: [
      "Silver Dollar Plant",
      "Chinese Jade",
      "Silver Dollar Jade",
    ...
    category_type: ["green", "succulent", "blue", "silver", "burgundy"],
    origin: "South Africa",
    description:
      "The lotus under the succulents, the Crassula Garnet Lotus. Crassula 'Garnet Lotus' is a truly stunning succulent with thick frosty purple garnet-colored leaves that taper to a point and are held upright in a lotus-shaped rosette.",
    fun_fact:
    ...
    careDetails: {
      ...
      care_level: "Easy",
      watering:
        "Thoroughly water the compost and allow it to dry out before re-watering. Water less in winter and allow the compost to remain drier for longer.",
      light:
        "This plant prefers bright conditions. Direct sunlight is beneficial to this plant, however be cautious of letting it scorch in midday summer sun.",
      benefits: "",
    },
    images: {
      preview_url: "",
