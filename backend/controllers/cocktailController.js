...
// exports.addCocktailController = [
//     upload.single('image'),
//     async (req, res) => {
//       console.log('Body:', req.body); // Should log form fields other than files
//       console.log('File:', req.file); // Should log file information if a file is uploaded
...
//         console.log('Request after processing:', req.body);
